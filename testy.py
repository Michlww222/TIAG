...
class ProductionTest(unittest.TestCase):
    ...
    dataP1G1 = GraphData.GraphData(newG1)
    dataP1G2 = GraphData.GraphData(newG2)
    dataP1G3 = GraphData.GraphData(newG3)
    dataP1G4 = GraphData.GraphData(newG4)
    dataP1G5 = GraphData.GraphData(newG5)
    dataP1G6 = GraphData.GraphData(newG6)
    ...
    dataP2G1 = GraphData.GraphData(newG1)
    dataP2G2 = GraphData.GraphData(newG2)
    dataP2G3 = GraphData.GraphData(newG3)
    dataP2G4 = GraphData.GraphData(newG4)
    dataP2G5 = GraphData.GraphData(newG5)
    dataP2G6 = GraphData.GraphData(newG6)
    ...
    dataP3G1 = GraphData.GraphData(newG1)
    dataP3G2 = GraphData.GraphData(newG2)
    dataP3G3 = GraphData.GraphData(newG3)
    dataP3G4 = GraphData.GraphData(newG4)
    dataP3G5 = GraphData.GraphData(newG5)
    dataP3G6 = GraphData.GraphData(newG6)
    ...
    dataP4G1 = GraphData.GraphData(newG1)
    dataP4G2 = GraphData.GraphData(newG2)
    dataP4G3 = GraphData.GraphData(newG3)
    dataP4G4 = GraphData.GraphData(newG4)
    dataP4G5 = GraphData.GraphData(newG5)
    dataP4G6 = GraphData.GraphData(newG6)
    ...
    def test_Production3(self):
        ...
        self.assertEqual(components_nuber,1)
